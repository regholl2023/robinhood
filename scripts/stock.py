...
class STOCK:
    ...
    def recommend_buying(self):
        i_percentage_change = ((self.current_stock_value - self.highest_stock_value) / (self.highest_stock_value)) * 100
    ...
    def recommend_selling(self):
        i_percentage_change = ((self.current_stock_value - self.lowest_stock_value) / (self.lowest_stock_value)) * 100
